  ...
  * **************************************************** */
  ...
  switch ($action) {
    case 'upload':
      ...
      if($imageCheck){
        $message = "<p class='error-msg'>An image by that name already exists.</p>";
      } elseif (empty($invId) || empty($imgName)) {
        $message = "<p class='error-msg'>You must select a vehicle and image file for the vehicle.</p>";
      } else {
        ...
        if ($result) {
        $message = "<p class='success-msg'>The upload succeeded.</p>";
        } else {
    ...
    case 'delete':
      ...
      if ($remove) {
        $message = "<p class='success-msg'>$filename was successfully deleted.</p>";
      } else {
        $message = "<p class='error-msg'>$filename was NOT deleted.</p>";
      }
    ...
    default:
      ...
      if (count($imageArray)) {
        ...
        $imageDisplay = "<p class='error-msg'>Sorry, no images could be found.</p>";
      }
